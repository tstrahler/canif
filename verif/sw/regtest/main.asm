...
000000e4 <__crt0_call_constructors>:
  e4:	1f400413          	li	s0,500
  e8:	1f400493          	li	s1,500
...
00000114 <__crt0_call_destructors>:
 114:	1f400413          	li	s0,500
 118:	1f400493          	li	s1,500
...
00000190 <main>:
 ...
 198:	09000593          	li	a1,144
 19c:	00000513          	li	a0,0
 1a0:	038000ef          	jal	ra,1d8 <can_read_32>
 1a4:	00a12623          	sw	a0,12(sp)
 1a8:	09000593          	li	a1,144
 1ac:	00100513          	li	a0,1
 1b0:	028000ef          	jal	ra,1d8 <can_read_32>
 1b4:	00a12423          	sw	a0,8(sp)
 1b8:	09000593          	li	a1,144
 1bc:	00200513          	li	a0,2
 1c0:	018000ef          	jal	ra,1d8 <can_read_32>
 1c4:	00a12223          	sw	a0,4(sp)
 1c8:	00000513          	li	a0,0
 1cc:	01c12083          	lw	ra,28(sp)
 1d0:	02010113          	addi	sp,sp,32
 1d4:	00008067          	ret

000001d8 <can_read_32>:
 1d8:	00c51513          	slli	a0,a0,0xc
 1dc:	00b50533          	add	a0,a0,a1
 1e0:	00251513          	slli	a0,a0,0x2
 1e4:	a00005b7          	lui	a1,0xa0000
 1e8:	00a58533          	add	a0,a1,a0
